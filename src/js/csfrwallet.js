...
function warningOnExit() {
  if (needWarningOnExit()) {
    return "If you log out, any Saffroncoin sell orders you have open will probably not be filled.";
  }
}
...
$(document).ready(function() {
  ...
  $.reject({  
    ...
    header: 'Your browser is not supported with SFRDirect',
    paragraph1: "SFRDirect's security features require a newer browser than what you are using. We recommend Chrome for the best user experience."
  ...
  loadcSFRwalletConfigFromServer();
